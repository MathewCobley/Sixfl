...
const oldLauncher = [
  ...
  '        className={',
  '          captainMatch',
  '            ? "player-temporary-pass-launcher fixed bottom-5 right-5 z-[90] rounded-full bg-emerald-400 px-5 py-3 text-sm font-bold text-black shadow-2xl hover:bg-emerald-300"',
  '            : "player-temporary-pass-launcher fixed bottom-5 right-5 z-[90] rounded-full border border-emerald-400/30 bg-[#10241b] px-5 py-3 text-sm font-semibold text-emerald-100 shadow-2xl hover:bg-[#163326]"',
  '        }',
  '      >',
...
const clearerLauncher = [
  ...
  '          type="button"',
  '          onClick={() => void openLauncher()}',
  '          className="player-temporary-pass-launcher fixed bottom-5 right-5 z-[90] rounded-full bg-emerald-400 px-5 py-3 text-sm font-bold text-black shadow-2xl hover:bg-emerald-300"',
  '        >',
  '          + Add temporary player',
  '        </button>',
  '      ) : (',
  '        <div className="player-temporary-pass-launcher fixed bottom-5 right-5 z-[90] w-[min(22rem,calc(100vw-2.5rem))] rounded-2xl border border-emerald-400/25 bg-[#10241b]/95 p-3 shadow-2xl backdrop-blur">',
