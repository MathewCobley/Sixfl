...
const checks = [
  ...
  [kitTerms.includes('KIT_OFFER_TERMS_VERSION = "2.3"'), "Kit Offer Terms must remain on v2.3"],
  [kitTerms.includes('id: "founding-team-kit-terms-2-2"'), "Kit Offer Terms v2.2 must remain archived"],
  [kitTerms.includes('id: "founding-team-kit-terms-2-1"'), "Kit Offer Terms v2.1 must remain archived"],
  [kitTerms.includes("Kits supplied under a SIXFL free kit offer are conditional on the team remaining an active member of the league until the free kit has been delivered."), "Kit Offer Terms v2.3 must retain continued-league-membership protection"],
  [kitTerms.includes("This withdrawal condition does not apply to kits or additional items that the team or purchaser has paid for in full."), "Kit terms must keep paid purchases separate from the free-kit withdrawal condition"],
