...
export default async function AdminPaymentsPage({
  ...
  const filteredOpenPlayerFees = openPlayerFees.filter((fee) => {
    const playerName = getPlayerFeeName({ teamMember: fee.teamMember, prospect: fee.prospect, historicalIdentity: fee.historicalIdentity });
    const playerContact = getPlayerFeeContact({ teamMember: fee.teamMember, prospect: fee.prospect, historicalIdentity: fee.historicalIdentity });
