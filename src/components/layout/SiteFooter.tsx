  ...
  return (
    <footer className="border-t border-white/10 bg-black text-white">
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
        {/* Mobile stacks cleanly, tablet gets 2 columns, desktop gets full footer grid. */}
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-10">
          ...
          <div className="max-w-md sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center">
              <Image
                ...
                width={200}
                height={60}
                className="h-auto w-36 sm:w-auto"
              />
            </Link>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col gap-2 text-sm text-white/80">
              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/leagues">
                Leagues
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/venues">
                Venues
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/pricing">
                Pricing
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/faq">
                FAQ
              </Link>

              <Link
                className="rounded-lg py-1.5 font-semibold text-white transition hover:text-emerald-400"
                href="/register-team"
              >
                Register
              </Link>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col gap-2 text-sm text-white/80">
              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/league-rules">
                League Rules
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/league-agreement">
                League Agreement
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/referee-agreement">
                Referee Agreement
              </Link>

              <Link className="rounded-lg py-1.5 transition hover:text-emerald-400" href="/match-rules">
                Match Rules
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col gap-2 text-sm text-white/80">
              <Link
                className="rounded-lg py-1.5 transition hover:text-emerald-400"
