        ...
        <div class="flex flex-col gap-3 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div class="flex flex-wrap items-center gap-2">
              <div class="text-base font-semibold text-white">${fixture.label}</div>
            ...
            <div class="mt-1 text-sm text-white/60">${fixture.kickoffLabel}</div>
          </div>
          <div class="text-sm sm:text-right">
            <div class="text-white/65">${fixture.venueName}</div>
            <div class="mt-2">
