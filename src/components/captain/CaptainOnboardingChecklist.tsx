...
export default function CaptainOnboardingChecklist({
  ...
  const items: ChecklistItem[] = [
    ...
    {
      title: "Read captain terms",
      text: "Check fixture availability, payment responsibilities, cancellations, avoidable admin fees and captain responsibilities before your first game.",
      tone: status.isAgreementAccepted ? "complete" : "attention",
      href: `/captain/team/${teamId}/guide`,
      actionLabel: "Captain terms",
    },
  ];
