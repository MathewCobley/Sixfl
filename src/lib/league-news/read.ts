...
type PublicRow = { id: string; leagueSlug: string; publishedAt: Date; updatedAt: Date; snapshot: unknown; matchweekNumber: number | null };
const publicRow = (r: PublicRow): PublishedNews => ({
  id: r.id,
  leagueSlug: r.leagueSlug,
  publishedAt: r.publishedAt.toISOString(),
  updatedAt: r.updatedAt.toISOString(),
  matchweekNumber: Number.isInteger(r.matchweekNumber) ? Number(r.matchweekNumber) : null,
  article: readNewsSnapshot(r.snapshot),
});
