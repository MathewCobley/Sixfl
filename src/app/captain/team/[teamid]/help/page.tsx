...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Make sure every player has an email address saved before setting up squad payments.",
  ...
  },
  {
    ...
    intro: "Squad payments let you decide who is contributing to a fixture, how much each player should pay and whether SIXFL should send them a payment link. The captain still remains responsible for making sure the team fee is covered.",
    steps: [
      "Before you start, open Squad and make sure every player has an email address saved. SIXFL payment links are sent by email, so if an email is missing the link cannot be sent.",
      "Open Payments → Squad payments and choose the correct fixture. Always check the fixture before entering anything.",
      "Enter the Default amount per player. This is the normal amount most of your selected players will pay.",
      "Tick every player who should contribute to that fixture. Only select players who should be included in that week's collection.",
      "If one player is paying a different amount, enter their amount in the box next to their name. Leave it blank to use the default amount.",
      "Choose how each selected player is paying: Send SIXFL payment link, Captain already collected, or Waived / no charge.",
      "Use Send SIXFL payment link when the player should pay SIXFL online. Use Captain already collected if the player has already paid you directly. Only use Waived / no charge when the player genuinely owes nothing.",
      "Check the fixture, selected players, amounts and collection methods, then click Save player collection.",
      "After saving, use Player payment status to see who is awaiting payment, who has paid, what the captain has already collected and what is still outstanding.",
      "Do not untick someone from an existing unpaid collection unless you really want to remove them. Saving after unticking them cancels their outstanding player payment request.",
    ],
    example: {
      title: "Dummy £40 split example",
      rows: [
        { label: "8 players", value: "£5 each = £40" },
        { label: "Different amount", value: "If Jack pays £10, enter £10 beside Jack and leave the other individual boxes blank" },
        { label: "Paid captain", value: "Choose Captain already collected if a player has already paid you by cash or bank transfer" },
        { label: "Online payment", value: "Choose Send SIXFL payment link when SIXFL should email the player a secure payment link" },
      ],
      note: "Important: make sure every player has an email address saved before setting up squad payments. If an email address is missing, SIXFL cannot email that player's payment link.",
    },
  },
  {
    id: "team-payments",
