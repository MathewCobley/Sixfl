    ...
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <div className="space-y-6">
          ...
          >
            <input type="hidden" name="teamId" value={prospect.team.id} />
            <input type="hidden" name="prospectId" value={prospect.id} />
            <input type="hidden" name="from" value={`/admin/teams/${prospect.team.id}/prospects/${prospect.id}/communications`} />
            ...
            <div className="mt-1 text-sm text-white/60">To: {prospect.email || "No email set"}</div>
          ...
          >
            ...
            <div className="mt-1 text-sm text-white/60">To: {prospect.phone || "No mobile set"}</div>
