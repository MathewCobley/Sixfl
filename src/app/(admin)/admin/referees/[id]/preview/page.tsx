        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-amber-50/80">
              You are previewing the referee dashboard for {referee.name || referee.email || "this referee"}.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3">
              <div className="text-[11px] uppercase tracking-[0.16em] text-white/40">Open nights</div>
              <div className="mt-1 text-lg font-semibold text-white">{openNights.length}</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3">
              <div className="text-[11px] uppercase tracking-[0.16em] text-white/40">Submitted</div>
              <div className="mt-1 text-lg font-semibold text-white">{submittedNights.length}</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3">
              <div className="text-[11px] uppercase tracking-[0.16em] text-white/40">Due SIXFL</div>
              <div className="mt-1 text-lg font-semibold text-white">{formatMoney(dueToSixfl)}</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3">
              <div className="text-[11px] uppercase tracking-[0.16em] text-white/40">Due to you</div>
              <div className="mt-1 text-lg font-semibold text-white">{formatMoney(dueToReferee)}</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  <Link
                    ...
                    className="inline-flex h-10 items-center justify-center rounded-xl border border-white/10 bg-white/[0.05] px-4 text-sm font-semibold text-white transition hover:bg-white/[0.08]"
                  >
                    Admin night record
                  </Link>
                </div>
