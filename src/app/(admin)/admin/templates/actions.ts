...
export async function ensureYesIWantToPlayTemplateAction() {
  ...
  const template = await prisma.emailTemplate.upsert({
    ...
    update: {
      ...
      description: "Simple squad-player email asking for a clear YES/NO reply so SIXFL knows who still wants to play.",
      audience: "PLAYER",
      interestType: "PLAYER",
      subject: "Do you still want to play in a SIXFL team?",
      body: YES_I_WANT_TO_PLAY_BODY,
      ctaLabel: null,
      ctaUrlKey: null,
      isActive: true,
    },
