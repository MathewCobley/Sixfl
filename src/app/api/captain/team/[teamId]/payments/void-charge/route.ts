// ========================================
// File: src/app/api/captain/team/[teamId]/payments/void-charge/route.ts
// ========================================
...
export async function POST(
  ...
  if (paidTotalPence > 0) {
    return NextResponse.json(
      {
        error:
          "This team charge already has a recorded payment, so it has not been voided. Review/refund it manually first.",
        paidTotalPence,
      },
      { status: 409 },
    );
  ...
  await cancelQueuedMatchFeeNotificationDispatches([charge.id], prisma, {
    reason: `Team match fee charge voided: ${reason}`,
  });
