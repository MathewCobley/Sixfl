// ========================================
// File: src/app/api/captain/team/[teamid]/mark-player-not-interested/route.ts
// ========================================
  ...
  try {
    ...
    if (!access.isAdmin) {
      return NextResponse.json(
        { error: "Only admin can mark a squad player as not interested." },
        { status: 403 },
      );
    }
    ...
    if (!result.ok) {
      return NextResponse.json(
        { error: "Squad member could not be marked as not interested." },
        { status: 404 },
      );
    }
