-- Re-render active Goal of the Month nominee clips after highlighting the scorer's
-- team in the fixture scoreline. Existing rendered objects stay available until
-- the worker safely replaces them.
